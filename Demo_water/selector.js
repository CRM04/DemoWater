...
$(document).ready(function(){
        ...
        //localStorage.removeItem("fechas");  
          ...
          $("#centro").height($("#centro").css("height"));
            ...
            $("#agregar").click(function(){
                switch(actual){
                    case 1:
                        var prodCantidad = document.getElementById("cantidad").innerHTML;
                        if (prodCantidad>1){
                            var prod = "Garrafones";
                        }else{
                            var prod = "Garrafón";
                    ...
                    case 3:
                        var prodCantidad = document.getElementById("cantidad").innerHTML;
                        if (prodCantidad>1){
                            var prod = "Botellas de 1L";
                        }else{
                            var prod = "Botella de 1L";
                        }
                        var id = "1l";
                        break;
                    case 4:
                        var prodCantidad = document.getElementById("cantidad").innerHTML;
                        if (prodCantidad>1){
                            var prod = "Botellas de 1 1/2 L";
                        }else{
                            var prod = "Botella de 1 1/2 L";
                        }
                        var id = "1ym";
                        break;
                    case 5:
                        var prodCantidad = document.getElementById("cantidad").innerHTML;
                        if (prodCantidad>1){
                            var prod = "Botellas de 600 ml";
                        }else{
                            var prod = "Botella de 600 ml";
                        }
                        var id = "600";
                        break;                        
                }
                swal({
                    title: "¿Estás seguro?",
                    text: "Se agregarán " +prodCantidad+" "+prod +" de agua a su pedido.",
                    type: "info",
        ...
        function transicion(){                        
            ...
            if(actual > total){
                ...
                console.log("actual- "+actual);
                $("#"+actual.toString()).delay(100).fadeIn(100);
            }                                    
        }

        function transicionIzq(){                        
            console.log("actual "+actual);
            if(actual < 1){
                console.log("Set");
                actual = 5;
